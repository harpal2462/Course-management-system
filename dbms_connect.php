...
$sql1 = "CREATE TABLE IF NOT EXISTS available_course(course_id INT NOT NULL PRIMARY KEY AUTO_INCREMENT,course_name VARCHAR(50) NOT NULL ,course_discription VARCHAR(800),course_prize INT);";
